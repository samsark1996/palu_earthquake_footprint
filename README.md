...
PLEASE NOTE: The input file for Rmarkdown needs to be generated by OpenQuake
first. As it is too large to upload in github, it is excluded here. However,
the user can generate it with OpenQuake setup using the files in the folder
[OQ_input](https://github.com/samsark1996/palu_earthquake_footprint/tree/main/OQ_input).
Please read the OpenQuake documentation first.
